...
class PlatformAgent(object):
    ...
    def __init__(self, simData, platform_id):
        ...
        self.event_based = self.sim.arguments.get('event_based', True)  # way of handling the reuqests
        ...
        self.monitor = self.sim.arguments.get('monitor', False)  # do we record queue lengths
        self.Qs = list()

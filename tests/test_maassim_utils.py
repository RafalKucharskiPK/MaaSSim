...
class TestUtils(unittest.TestCase):
    ...
    def test_networkIO(self):
        ...
        inData = download_G(inData, self.params)  # download the graph and compute the skim
        save_G(inData, self.params)  # save it to params.paths.G
        inData = load_G(inData, self.params,
